...
{ 
    ...
    { 
        ...
        { 
            if(L[i]<m) Temp[0][n]=L[i]; 
            else Lsp=(L[i]/m)%10; //确定关键字 
            Temp[lsp][n]=L[i]; 
            n++; 
        } 
...
## KMP
手算KMP匹配的Next值和Nextval值[https://www.slyar.com/blog/kmp-next-nextval.html](https://www.slyar.com/blog/kmp-next-nextval.html)
